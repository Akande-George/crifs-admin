    ...
    <div className="max-w-4xl mx-auto space-y-6 md:space-y-8 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <button className="h-9 md:h-10 px-3 md:px-4 rounded-lg border border-neutral-200 text-[10px] md:text-sm font-bold text-neutral-600 hover:bg-neutral-50 transition-all flex items-center gap-1.5">
              ...
              {activeTab === "Financial" && (
                <section className="space-y-6">
                  <h3 className="text-base md:text-lg font-bold text-neutral-900 flex items-center gap-2">
                    <Percent className="h-4 w-4 md:h-5 md:w-5 text-brand-500" /> Financial Parameters
                  </h3>
                  
                  <div className="grid grid-cols-1 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">Platform Processing Fee (%)</label>
                      <div className="relative">
                        <input type="number" defaultValue={3.5} className="w-full h-11 rounded-xl border border-neutral-200 bg-surface px-4 text-sm focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/5 transition-all" />
                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 font-bold text-sm">%</span>
                      </div>
                      <p className="text-[10px] text-neutral-400">Charged on every successful disbursement.</p>
                    </div>

                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">Max Funding Tenure (Months)</label>
                      <input type="number" defaultValue={24} className="w-full h-11 rounded-xl border border-neutral-200 bg-surface px-4 text-sm focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/5 transition-all" />
                    </div>
                  </div>
                </section>
              )}
